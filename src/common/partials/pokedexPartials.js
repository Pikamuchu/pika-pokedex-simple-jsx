const { resultTileRender } = require('../renders/pokedexRenders');

export const headerPartial = title => (
...
export const resultsPartial = (results, labels) => (
...
export const filtersPartial = results => (
...
export const detailsPartial = (details, labels) => (
